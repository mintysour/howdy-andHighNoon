...
const storyData = [
  ...
  { text: "{PlayerName}: This morning we found Detective Harper shot dead in the town. I need your cooperation in the investigation. ", speaker: null},
  { text: "Bartender Alexa: No… It can’t be…", speaker: "bartender"},
  { text: "{PlayerName}: Do you have any information?", speaker: null},
  ...
  { text: "{PlayerName}: And why is that?", speaker: null},
  ...
  { text: "{PlayerName}: Alright, well that accounts for your location. Was anyone there to see you?", speaker: null}, 
  ...
  { text: "{PlayerName}: Alright, thank you for your time.", speaker: null},
