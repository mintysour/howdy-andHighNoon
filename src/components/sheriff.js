...
const storyData = [
  { text: "The neighbor, Theodore, lives next door to Detective Harper. Age: 56.", speaker: "sheriff" },
  { text: "{PlayerName}: Howdy Neighbor! I’m investigating the murder of Detective Harper.", speaker: "sheriff"},
  { text: " Neighbor Theodore: Harper?! Dead?! This can’t be… she was alive just a few days ago…", speaker: "sheriff"}
];
