...
const storyData = [
  ...
  { text: "{PlayerName}: I know, it’s all very sudden, but as her apprentice I’m trying to get to the bottom of it as soon as possible. Do you have any information at all?", speaker: null},
  ...
  { text: "{PlayerName}: Who do you think it could be? ", speaker: null},
  ...
  { text: "{PlayerName}: Childhood friends?", speaker: null},
  ...
  { text: "{PlayerName}: Wow, I had no clue… Do you have any other information for me?", speaker: null},
  ...
  { text: "{PlayerName}: Alright, this is good information thank you. However, what were you doing last night?", speaker: null},
  ...
  { text: "{PlayerName}: Was there anyone able to account for your location?", speaker: null},
  ...
  { text: "{PlayerName}: Okay, thank you. This will all be really helpful.", speaker: null},
